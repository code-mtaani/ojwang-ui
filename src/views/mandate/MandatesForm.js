...
function MandatesForm(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    const onSuccess = ({ data }) => {
      toast.success('Successfully submitted new mandate', {
        position: 'top-right',
        autoClose: 1200,
    ...
    const onFailure = (error) => {
      toast.error('An error occured when saving the mandate', {
        position: 'top-right',
        autoClose: 1200,
        hideProgressBar: true,
        closeOnClick: true,
    ...
    axiosPrivate.post('/v1/mandate/', payload).then(onSuccess).catch(onFailure)
  }
  ...
  const handleEdit = async (e) => {
    ...
    const onSuccess = ({ data }) => {
      toast.success('Successfully submitted edited mandate', {
        position: 'top-right',
        autoClose: 1200,
        hideProgressBar: true,
        closeOnClick: true,
    ...
    axiosPrivate.patch(`/v1/mandate/${id}`, payload).then(onSuccess).catch(onFailure)
  }
